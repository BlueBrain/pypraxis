...
!
!l    Input, real ( kind = 8 ) X(N), the base point of the search.
!
...
!
!    22 May 2006
!    09 Sep 2009, minor modifications for SciPy-compliant printout. CSH
!
!  Author:
!
!    Richard Brent
...
!    1, printing according to scipy.optimize conventions.
!    2, F is printed after every n+1 or n+2 linear minimizations.  
!       final X is printed, but intermediate X is printed only 
!       if N is at most 4.
!    3, the scale factors and the principal values of the approximating 
!       quadratic form are also printed.
!    4, X is also printed after every few linear minimizations.
!    5, the principal vectors of the approximating quadratic form are 
!       also printed.
!
...
subroutine printsp ( fx, nf, nl )

!*****************************************************************************80
!
!! PRINTSP prints scipy-compliant output
!
!  Modified:
!
!    08 Sep 2009
...
!
  ...
  write ( *, '(a)' )        'Optimization terminated successfully.'
  write ( *, '(a,5g14.6)' ) '         Current function value: ', fx
  write ( *, '(a,i8)' )     '         Linear searches: ', nl
  write ( *, '(a,i8)' )     '         Function evaluations: ', nf 
